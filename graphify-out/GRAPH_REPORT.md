...
## Summary
- 6967 nodes · 15279 edges · 325 communities (313 shown, 12 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 233 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0883cbc9`
...
Cohesion: 0.03
Nodes (141): applyGlobalBarLabelState(), applyPlaceholderSizingStyles(), applySvelteComponentVariantStyle(), averageRgb01(), bindEditBadgeProxy(), bufferToBase64(), buildCollapsible(), buildColorModels() (+133 more)

### Community 8 - ".claude/skills/impeccable/scripts/live-browser.js"
Cohesion: 0.03
Nodes (150): addManualContextText(), applyEditing(), applyGlobalBarLabelState(), applyPlaceholderSizingStyles(), applySvelteComponentVariantStyle(), bindEditBadgeProxy(), bufferToBase64(), buildCollapsible() (+142 more)

### Community 9 - ".agents/skills/impeccable/scripts/lib/staleness-deep.mjs"
Cohesion: 0.21
...
Cohesion: 0.04
Nodes (118): ANIMATION_VALUE_KEYWORDS, borderColorsFromStyle(), borderWidthsFromStyle(), checkBorders(), checkClippedOverflow(), checkCreamPalette(), checkEdgeFlushCardsDOM(), checkElementBlinkingCursorDOM() (+110 more)
...
Cohesion: 0.06
Nodes (78): applyParamDefaults(), applyParamValue(), applyPlaceholderDimensions(), applySavedSessionMeta(), buildInsertPlaceholderSnapshotFromDom(), buildParamsPanel(), buildPickedAnchorSnapshot(), captureAndEmit() (+70 more)
...
Cohesion: 0.06
Nodes (51): blankCssComments(), CSS_IN_JS_EXTENSIONS, detectText(), extFromFilePath(), extractCSSinJS(), extractStyleBlocks(), firstOverusedGoogleFont(), hexChannels() (+43 more)

### Community 71 - "[]"
Cohesion: 0.12
Nodes (9): [], article, relatedPosts, string, tocChevron, tocContent, tocHeadings, tocLinks (+1 more)

### Community 72 - ".claude/skills/impeccable/scripts/lib/staleness-deep.mjs"
Cohesion: 0.19
Nodes (18): checkDesignCoverage(), checkDesignDrift(), checkDetectorIgnores(), checkHookInstallation(), checkLegacyLiveState(), checkWorkspaces(), collectHookCommands(), finding() (+10 more)
...
### Community 85 - ".agents/skills/impeccable/scripts/live/session-store.mjs"
Cohesion: 0.11
...
Cohesion: 0.10
Nodes (38): checkColors(), checkElementAIPaletteDOM(), checkElementGlowDOM(), checkGlow(), checkHoverContrast(), checkHtmlPatterns(), collectCssCustomProps(), collectMarqueeKeyframes() (+30 more)
...
### Community 101 - "captureElementToBlob"
Cohesion: 0.17
...
Cohesion: 0.16
Nodes (22): getLiveAnnotationsDir(), getLiveDir(), args, buffer, cwd, pageUrlFilter, remaining, compactManualLogText() (+14 more)
...
### Community 114 - ".claude/skills/impeccable/scripts/doctor.mjs"
Cohesion: 0.12
...
### Community 124 - ".agents/skills/impeccable/reference/document.md"
Cohesion: 0.10
...
Cohesion: 0.19
Nodes (18): resolveProjectRoot(), CRITIQUE_DIR, firstExisting(), getDesignSidecarCandidates(), getDesignSidecarPath(), getImpeccableDir(), getLegacyLiveAnnotationsDir(), getLegacyLiveConfigPath() (+10 more)
...
### Community 138 - "readLiveServerInfo"
Cohesion: 0.21
...
### Community 141 - ".agents/skills/impeccable/scripts/live/source-search.mjs"
Cohesion: 0.32
Nodes (7): IMPECCABLE_DIR, matchesTemplateExtension(), findSessionFile(), findSourceFile(), NEVER_SOURCE_DIRS, SOURCE_SEARCH_DIRS, walk()

### Community 142 - "handleGo"
Cohesion: 0.12
Nodes (28): beginEditPin(), buildAnnotationsForCapture(), buildInsertPlaceholderSnapshotFromDom(), buildPickedAnchorSnapshot(), buildPinElement(), cancelEditingPin(), captureAndEmit(), checkpointPayload() (+20 more)
...
Cohesion: 0.11
Nodes (27): addManualContextText(), applyEditing(), buildLocatorForLeaf(), canRestoreManualEditElement(), contextElementForManualEdit(), copyEditContainerContext(), copyEditLeafContext(), directMixedTextRestoreNodes() (+19 more)
...
Cohesion: 0.21
Nodes (11): getLiveSessionsDir(), safeSessionId(), applyEvent(), baseSnapshot(), COMPLETED_PHASES, GENERATION_FENCED_PHASES, getJournalPath(), getSnapshotPath() (+3 more)
...
### Community 321 - ".agents/skills/impeccable/scripts/lib/provider.mjs"
Cohesion: 0.50
Nodes (3): IMPECCABLE_COMMAND, IMPECCABLE_COMMAND_PREFIX, IMPECCABLE_PROVIDER_ID

### Community 322 - ".claude/skills/impeccable/scripts/lib/provider.mjs"
Cohesion: 0.50
Nodes (3): IMPECCABLE_COMMAND, IMPECCABLE_COMMAND_PREFIX, IMPECCABLE_PROVIDER_ID

## Knowledge Gaps
- **1861 isolated node(s):** `here`, `API_BASE`, `API_TIMEOUT_MS`, `localStates`, `SEED_MODES` (+1856 more)
...
- **Why does `_e()` connect `.claude/skills/impeccable/scripts/modern-screenshot.umd.js` to `ne`?**
