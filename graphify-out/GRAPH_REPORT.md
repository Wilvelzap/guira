# Graph Report - guira  (2026-08-03)

## Corpus Check
- 331 files · ~2,743,703 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6965 nodes · 15277 edges · 318 communities (306 shown, 12 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 233 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c02b1f0e`
...
## Communities (318 total, 12 thin omitted)
...
### Community 4 - "scanCssTextForPulsingDot"
Cohesion: 0.13
Nodes (27): checkHtmlPatterns(), collectCssCustomProps(), collectMarqueeKeyframes(), collectPulseKeyframes(), cssLengthToPx(), cssTextHasDarkRootBg(), extractShadowLengths(), findShadowColor() (+19 more)
...
Cohesion: 0.03
Nodes (132): acceptedDomAlreadyClean(), addManualContextText(), applyGlobalBarLabelState(), applyParamValue(), applyPlaceholderSizingStyles(), applySvelteComponentVariantStyle(), averageRgb01(), bufferToBase64() (+124 more)
...
Cohesion: 0.03
Nodes (108): ANIMATION_VALUE_KEYWORDS, borderColorsFromStyle(), borderWidthsFromStyle(), checkBorders(), checkClippedOverflow(), checkEdgeFlushCardsDOM(), checkElementBlinkingCursorDOM(), checkElementBorders() (+100 more)
...
Cohesion: 0.07
Nodes (68): applyOriginalAttrsToSvelteAnchor(), applyParamDefaults(), applySavedSessionMeta(), checkpointPayload(), clampVariantIndex(), clearHandled(), closedClipPath(), completeParameterPublication() (+60 more)
...
Cohesion: 0.05
Nodes (56): browserColorsClose(), browserDesignSystemConfig(), browserHasDirectText(), browserPrimaryFont(), browserRadiusTokens(), browserSampleText(), checkBrowserDesignSystemSources(), checkClippedOverflow() (+48 more)
...
Cohesion: 0.07
Nodes (79): abortSvelteComponentInjection(), applyEditing(), buildLocatorForLeaf(), buildPickedAnchorSnapshot(), cancelEditing(), cancelEditingToPicking(), cancelInsertConfigure(), cleanup() (+71 more)
...
Cohesion: 0.08
Nodes (49): armPageChatForTyping(), attachSteerFocusDebug(), attachSteerFocusGuard(), buildSteerProcessingDots(), clearSteerAwaitTimer(), clearSteerFocusRecoverTimer(), collapsePageChat(), expandPageChat() (+41 more)
...
### Community 43 - "el"
Cohesion: 0.07
Nodes (59): measureHiddenTextDOM(), measureHiddenTextDOM(), actionLabel(), applyConfigureBarChrome(), bindConfigureCountPillTooltip(), bindConfigureInlineControlHover(), bindConfigureModifierPillHover(), buildConfigureActionControl() (+51 more)
...
### Community 57 - ".agents/skills/impeccable/scripts/detector/engines/static-html/detect-html.mjs"
Cohesion: 0.13
...
Cohesion: 0.11
Nodes (33): checkColors(), checkElementGlow(), checkGlow(), checkHtmlPatterns(), collectCssCustomProps(), collectMarqueeKeyframes(), collectPulseKeyframes(), colorToHex() (+25 more)
...
Cohesion: 0.11
Nodes (36): checkBorders(), checkElementAIPaletteDOM(), checkElementBorders(), checkElementBordersDOM(), checkElementColors(), checkElementColorsDOM(), checkElementGlowDOM(), checkElementHoverContrast() (+28 more)

### Community 85 - ".agents/skills/impeccable/scripts/lib/impeccable-paths.mjs"
Cohesion: 0.07
Nodes (51): CRITIQUE_DIR, firstExisting(), getDesignSidecarPath(), getImpeccableDir(), getLegacyLiveConfigPath(), getLegacyLiveServerPath(), getLegacyLiveSessionsDir(), getLiveAnnotationsDir() (+43 more)
...
### Community 95 - ".claude/skills/impeccable/reference/document.md"
Cohesion: 0.10
...
### Community 96 - "scanCssTextForPulsingDot"
Cohesion: 0.14
...
### Community 101 - "documentRefForElement"
Cohesion: 0.10
...
### Community 108 - "captureElementToBlob"
Cohesion: 0.13
...
### Community 126 - "loadContext"
Cohesion: 0.15
Nodes (19): hasVisualImplementation(), loadContext(), parseCliOptions(), resolveProjectRoot(), getLegacyLiveAnnotationsDir(), parseTargetOptions(), parseTargetPath(), TargetArgError (+11 more)
...
### Community 131 - "syncEditBadgeHitProxies"
Cohesion: 0.27
Nodes (10): bindEditBadgeProxy(), editBadgeProxyTargets(), initEditBadge(), initEditBadgeHitProxies(), positionEditBadge(), proxyMouseEvent(), setImportantStyle(), styleEditBadgeProxy() (+2 more)

### Community 132 - "syncEditBadgeHitProxies"
Cohesion: 0.27
Nodes (10): bindEditBadgeProxy(), editBadgeProxyTargets(), initEditBadge(), initEditBadgeHitProxies(), positionEditBadge(), proxyMouseEvent(), setImportantStyle(), styleEditBadgeProxy() (+2 more)
...
### Community 143 - "scheduleLazyVisualContrast"
Cohesion: 0.18
...
### Community 145 - "postSerializedFindings"
Cohesion: 0.33
...
### Community 174 - "$impeccable hooks"
Cohesion: 0.33
...
### Community 199 - "Visualize: Direction Comps & Asset Production"
Cohesion: 0.33
...
### Community 237 - ".agents/skills/impeccable/scripts/detector/shared/inline-ignores.mjs"
Cohesion: 0.40
...
### Community 259 - "normalizeGitHubEvent"
Cohesion: 0.38
...
### Community 284 - "resolveLiveInjectionAnchor"
Cohesion: 0.62
Nodes (7): elementMatchesOriginalMarkup(), findLiveElementForOriginalMarkup(), findLiveElementFromAnchorSnapshot(), isUsableInjectionAnchor(), normalizeElementClassName(), parseOriginalMarkupElement(), resolveLiveInjectionAnchor()
...
### Community 305 - "expandScanTargets"
Cohesion: 0.36
Nodes (8): coLocatedStylesheets(), expandScanTargets(), hasPathTraversal(), isInsideProject(), looksLikeProjectRoot(), normalizeScanTargets(), parseStaticStyleImports(), resolveCacheCwd()
...
### Community 319 - "Navbar.astro"
Cohesion: 0.60
Nodes (4): getLinkClass(), getMobileLinkClass(), isCurrent(), onProduct

### Community 320 - "handleReducedMotionChange"
Cohesion: 0.40
Nodes (5): cleanupWrappers(), handleReducedMotionChange(), initializeWrappers(), scheduleInitialization(), setupWrapper()

## Knowledge Gaps
- **1861 isolated node(s):** `Qué es Guira (una línea, para no perder el foco en ninguna sesión)`, `Nombres de entidad (disciplina estricta, error recurrente en el proyecto)`, `Vocabulario y posicionamiento — Guira Empresas`, `Estilo de escritura (aplica a todo texto de Guira, no solo copy de marketing)`, `Documentos históricos del repo` (+1856 more)
...
- **Why does `qt()` connect `.agents/skills/impeccable/scripts/modern-screenshot.umd.js` to `ne`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
